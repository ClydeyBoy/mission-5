            ...
            <div className='popupForm'>
                ...
                <form className='tenancyApplication'>
                    ...
                    <div className='viewing'>
                        ...
                        onChange = {(e) =>setViewing(e.target.value)} value={viewing}/> <label id='viewing'>Yes</label>
                        <input type="radio" name="viewing" id='viewing' 
                        onChange = {(e) =>setViewing(e.target.value)} value={viewing}/><label id='viewing'>No</label>
                    </div>
